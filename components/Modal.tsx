	...
	return (
		<Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
			<Dialog.Portal>
				...
				<Dialog.Content className='fixed drop-shadow-sm border border-neutral-700 top-[50%] left-[50%] max-h-ful h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-xl bg-neutral-900 p-[25px] focus:outline-none z-[60] '>
