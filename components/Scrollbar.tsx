...
const Scrollbar = ({
	...
	const handleTrackClick = useCallback(
		(e: any) => {
			...
			if (trackCurrent && contentCurrent) {
				...
				const clickRatio = (clientY - trackTop + thumbOffset) /
	...
	return (
		...
		>
			...
			<div className='grid gap-4 grid-flow-row place-items-center   transition z-50 bg-transparent absolute right-0 top-0 bottom-0'>
